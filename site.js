const siteConfig = {
  ...
  translations: {
    en: {
      ...
      heroPrimary: "Back on Kickstarter",
      heroSecondary: "Support on GoFundMe",
      ...
      searchLabel: "Built for intentional desks",
      searchTitle: "A live wallpaper for people who think in systems.",
      searchIntro: "SignalWall sits where your attention already goes: the desktop. It is made for Windows users, open-source builders, multi-monitor setups, desk setup creators, designers, founders, students, and anyone who wants quotes to behave like a quiet interface instead of a noisy poster.",
      useCaseOneTitle: "For multi-monitor desks",
      useCaseOneBody: "Assign one message across every screen or give each monitor its own theme, quote pack, color system, and role.",
      useCaseTwoTitle: "For open-source trust",
      useCaseTwoBody: "The source, build scripts, security policy, release notes, and verification workflow are public so the app can be inspected before it runs.",
      useCaseThreeTitle: "For calm productivity",
      useCaseThreeBody: "Use design, focus, strategy, motivation, learning, and founder-mode quote themes to keep the desk oriented without adding another feed.",
      backersLabel: "Founding backers",
      backersTitle: "The first signal came from a private backer.",
      backersIntro: "SignalWall exists because real people decided this quiet, open-source desktop system deserves to ship.",
      firstBackerTag: "First backer",
      firstBackerTagCloneOne: "First backer",
      firstBackerTagCloneTwo: "First backer",
      firstBackerTagCloneThree: "First backer",
      firstBackerNumber: "Backer 001",
      firstBackerName: "Private supporter",
      firstBackerBody: "The first person to back SignalWall on Kickstarter chose to stay private. Thank you for giving the project its first real vote of confidence.",
      firstBackerCta: "Back SignalWall",
      ...
      closingPrimary: "Back the campaign",
      gofundmeCta: "Support the runway",
      productHuntCta: "See the Product Hunt launch",
      faqLabel: "Quick answers",
      faqTitle: "What searchers and supporters usually ask.",
      faqOneQuestion: "What makes SignalWall different?",
      faqOneAnswer: "Most live wallpapers start with video or visual effects. SignalWall starts with text: hierarchy, pacing, themes, and screen-specific meaning.",
      faqTwoQuestion: "Is it safe to install?",
      faqTwoAnswer: "The code is public and the recommended workflow is source-first: inspect, build locally, verify releases, and avoid disabling Windows protections for an unsigned alpha.",
      faqThreeQuestion: "Can I customize the quotes?",
      faqThreeAnswer: "Yes. Add one phrase per line, group phrases by theme, choose same or different quotes across screens, then export the complete setup as a preset.",
    ...
    fr: {
      ...
      heroPrimary: "Soutenir sur Kickstarter",
      heroSecondary: "Aider sur GoFundMe",
      ...
      searchLabel: "Conçu pour les bureaux intentionnels",
      searchTitle: "Un fond d'écran dynamique pour les gens qui pensent en systèmes.",
      searchIntro: "SignalWall se place là où votre attention va déjà : le bureau. Il est conçu pour les utilisateurs Windows, les builders open source, les setups multi-écran, les créateurs de desk setup, les designers, les fondateurs, les étudiants et tous ceux qui veulent que les citations agissent comme une interface calme plutôt que comme une affiche bruyante.",
      useCaseOneTitle: "Pour les bureaux multi-écran",
      useCaseOneBody: "Affichez un même message sur tous les écrans ou donnez à chaque moniteur son propre thème, pack de citations, système de couleurs et rôle visuel.",
      useCaseTwoTitle: "Pour une confiance open source",
      useCaseTwoBody: "Le code source, les scripts de build, la politique de sécurité, les notes de version et le parcours de vérification sont publics pour que l'app puisse être inspectée avant exécution.",
      useCaseThreeTitle: "Pour une productivité calme",
      useCaseThreeBody: "Utilisez des thèmes de citations design, focus, stratégie, motivation, apprentissage et founder mode pour orienter le bureau sans ajouter un autre fil d'actualité.",
      backersLabel: "Backers fondateurs",
      backersTitle: "Le premier signal est venu d'un backer privé.",
      backersIntro: "SignalWall existe parce que de vraies personnes ont décidé que ce système de bureau calme et open source mérite d'être livré.",
      firstBackerTag: "Premier backer",
      firstBackerTagCloneOne: "Premier backer",
      firstBackerTagCloneTwo: "Premier backer",
      firstBackerTagCloneThree: "Premier backer",
      firstBackerNumber: "Backer 001",
      firstBackerName: "Soutien privé",
      firstBackerBody: "La première personne à soutenir SignalWall sur Kickstarter a choisi de rester privée. Merci d'avoir donné au projet son premier vrai vote de confiance.",
      firstBackerCta: "Soutenir SignalWall",
      ...
      closingPrimary: "Soutenir la campagne",
      gofundmeCta: "Financer la suite",
      productHuntCta: "Voir le lancement Product Hunt",
      faqLabel: "Réponses rapides",
      faqTitle: "Ce que les visiteurs et les soutiens demandent souvent.",
      faqOneQuestion: "Qu'est-ce qui rend SignalWall différent ?",
      faqOneAnswer: "La plupart des fonds d'écran dynamiques commencent par de la vidéo ou des effets visuels. SignalWall commence par le texte : hiérarchie, rythme, thèmes et sens propre à chaque écran.",
      faqTwoQuestion: "Est-ce que l'installation est sûre ?",
      faqTwoAnswer: "Le code est public et le parcours recommandé est source-first : inspecter, compiler localement, vérifier les releases et éviter de désactiver les protections Windows pour une alpha non signée.",
      faqThreeQuestion: "Puis-je personnaliser les citations ?",
      faqThreeAnswer: "Oui. Ajoutez une phrase par ligne, regroupez les phrases par thème, choisissez des citations identiques ou différentes selon les écrans, puis exportez toute la configuration dans un preset.",
