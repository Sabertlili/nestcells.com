const siteConfig = {
  ...
  translations: {
    en: {
      ...
      backersTitle: "The first signal came from Mitchell Mathew.",
      ...
      firstBackerBody: "The first person to back SignalWall on Kickstarter. Thank you for giving the project its first real vote of confidence.",
    ...
    fr: {
      ...
      backersTitle: "Le premier signal est venu de Mitchell Mathew.",
      ...
      firstBackerNumber: "Backer 001",
      firstBackerBody: "La première personne à soutenir SignalWall sur Kickstarter. Merci d'avoir donné au projet son premier vrai vote de confiance.",
